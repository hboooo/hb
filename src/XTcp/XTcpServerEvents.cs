...
namespace XTcp
{
    ...
    /// description:X TCP server events
    public class XTcpServerEvents
    {
        ...
        /// <summary>
        /// This event is fired when a message is received from a client and it is desired that X Tcp pass the byte array containing the message payload.
        /// If MessageReceived is set, StreamReceived will not be used.
        /// </summary>
        public event EventHandler<MessageReceivedEventArgs> MessageReceived;

        /// <summary> 
        /// This event is fired when a stream is received from a client and it is desired that X Tcp pass the stream containing the message payload to your application. 
        /// If MessageReceived is set, StreamReceived will not be used.
        /// </summary>
        ...
        internal void WrappedEventHandler(Action action, string handler, object sender)
        {
            ...
            Action<Severity, string> logger = ((XTcpServer)sender).Settings.Logger;
            ...
            {
                logger?.Invoke(Severity.Error, "Event handler exception in " + handler + ": " + Environment.NewLine + XSerialization.SerializeJson(e, true));
            }
        }
