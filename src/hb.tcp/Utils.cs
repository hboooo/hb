...
namespace hb.tcp
{
    ...
    internal static class Utils
    {
        ...
        internal static async Task<byte[]> ReadMessageDataAsync(XMessage msg, int bufferLen)
        {
            if (msg == null) throw new ArgumentNullException(nameof(msg));
            if (msg.ContentLength == 0) return new byte[0]; 
            return await Utils.ReadFromStreamAsync(msg.DataStream, msg.ContentLength, bufferLen); 
        }
        ...
        internal static DateTime GetExpirationTimestamp(XMessage msg)
        {
