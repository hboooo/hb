...
namespace hb.tcp
{
    ...
    /// description:X TCP client events
    public class XTcpClientEvents
    {
        ...
        /// <summary>  
        /// This event is fired when a message is received from the server and it is desired that X Tcp pass the byte array containing the message payload. 
        /// If MessageReceived is set, StreamReceived will not be used.
        /// </summary>
        public event EventHandler<MessageReceivedEventArgs> MessageReceived;

        /// <summary> 
        /// This callback is called when a stream is received from the server and it is desired that X Tcp pass the stream containing the message payload to your application. 
        /// If MessageReceived is set, StreamReceived will not be used.
        /// </summary>
