...
namespace hb.tcp
{
    ...
    /// description:Settings for X TCP server
    public class XTcpServerSettings
    {
        ...
        /// <summary>
        /// For X TCP server, the maximum amount of time to wait before considering a client idle and disconnecting them. 
        ...
        /// <summary>
        /// For X TCP server, specify the maximum number of connections the server will accept.
        ...
        /// <summary>
        /// For X TCP server, the list of permitted IP addresses from which connections can be received.
        /// </summary>
