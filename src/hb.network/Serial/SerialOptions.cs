...
namespace hb.network.Serial
{
    /// <summary>
    /// author     :habo
    /// date       :2021/7/24 0:19:37
    /// description:
    /// </summary>
    public class SerialOptions
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SerialOptions"/> class.
        /// </summary>
        ...
        public SerialOptions(string portName, int baudRate = 9600, int dataBits = 8, StopBits stopBits = StopBits.One, Parity parity = Parity.None, Handshake handshake = Handshake.None)
        {
        ...
        /// </param>
        public SerialOptions(string portName, int baudRate = 9600, int dataBits = 8, int stopBits = 1, int parity = 0, int handshake = 0) : this(portName, baudRate, dataBits, GetStopBits(stopBits), GetParity(parity), GetHandshake(handshake)) { }
        ...
        /// </param>
        public SerialOptions(string portName, int baudRate = 9600, int dataBits = 8, string stopBits = "one", string parity = "none", string handshake = "none") : this(portName, baudRate, dataBits, GetStopBits(stopBits), GetParity(parity), GetHandshake(handshake)) { }
