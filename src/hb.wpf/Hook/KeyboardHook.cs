...
namespace hb.wpf.Hook
{
    /// <summary>
    /// author     :habo
    /// date       :2021/7/25 13:33:28
    /// description:
    /// </summary>
    public class KeyboardHook : XHook
    {
        #region Events
        ...
        public event HookKeyEventHandler KeyPress;
        #endregion Events
        ...
        protected override int HookCallbackProcedure(int nCode, int wParam, IntPtr lParam)
        {
            ...
            if (nCode > -1 && (KeyDown != null || KeyUp != null || KeyPress != null))
            {
                ...
                HookKeyEventArgs e = new HookKeyEventArgs(
                        (Key)keyboardHookStruct.vkCode);
                    ...
                    KeyPress != null)
                {
                              ...
                              keyboardHookStruct.flags) == 1)
                    {
                        ...
                        HookKeyEventArgs e2 = new HookKeyEventArgs((Key)key);
                        KeyPress(this, e2);
                        handled = e.Handled;
                    }
                }
    ...
    {
        public HookKeyEventArgs(Key key)
        {
            Key = key;
        }
