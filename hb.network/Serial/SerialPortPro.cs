...
namespace hb.network.Serial
{
    ...
    public partial class SerialPortPro
    {
        ...
        public SerialOptions Options { get; private set; }
        ...
        public SerialDataFormat DataFormat { get; set; } = SerialDataFormat.Hex;
        ...
        /// </summary>
        private void Initialize(SerialOptions options)
        {
            try
            {
